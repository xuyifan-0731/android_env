...
class A11yService(object):
    ...
    def SendForest(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/android_env.A11yService/SendForest',
    ...
    def SendEvent(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/android_env.A11yService/SendEvent',
    ...
    def Bidi(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/android_env.A11yService/Bidi',
